package com.platform4j.arch.redis;
...
public class ShardedJedisSentinelPool extends Pool<ShardedJedis> {
    ...
    private void initPool(List<HostAndPort> masters) {
        if (!sameTo(currentHostMasters, masters)) {
    ...
    private boolean sameTo(List<HostAndPort> currentShardMasters, List<HostAndPort> shardMasters) {
